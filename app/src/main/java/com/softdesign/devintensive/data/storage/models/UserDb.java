...
public class UserDb {
    ...
    public UserDb(UserListRes.UserData userRes) {
    ...
    public List<Repository> getRepositories() {
        if (repositories == null) {
            ...
            List<Repository> repositoriesNew = targetDao._queryUserDb_Repositories(remoteId);
            synchronized (this) {
                if(repositories == null) {
    ...
    @Generated(hash = 804956713)
    public UserDb(Long id, @NotNull String remoteId, String photo,
